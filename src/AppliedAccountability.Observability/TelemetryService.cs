...
public class TelemetryService : ITelemetryService
{
    ...
    public TelemetryService(ILogger<TelemetryService> logger, string serviceName = "AppliedAccountability.Observability")
    {
        ...
        _counter = _meter.CreateCounter<long>("observability.counter", description: "Counter for various metrics");
        _histogram = _meter.CreateHistogram<double>("observability.histogram", description: "Histogram for distribution metrics");
